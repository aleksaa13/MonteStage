  ...
  return (
    <div className={styles.groupWrapper}>
      ...
      <div className={styles.place}>
        <strong>{group[0].grad}</strong>
      </div>

      <div className={styles.kontakt}>
        <span className={styles.email}>{group[0].email}</span>
        <span className={styles.mobile}>{group[0].mobile}</span>
      ...
      <div className={styles.info}>{group[0].info}</div>
